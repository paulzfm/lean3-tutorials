...
begin
  rcases h1 with ⟨k, rfl⟩, -- destruct h1 as [k ->]
...
begin
  rintros ⟨k, rfl⟩ ⟨l, rfl⟩, -- intros [k ->] [l ->]
  use k+l,
  ring,
end
...
begin
  split,
  { rintros ⟨k, rfl⟩, linarith, },
  { rintros rfl, apply dvd_refl, }
end
